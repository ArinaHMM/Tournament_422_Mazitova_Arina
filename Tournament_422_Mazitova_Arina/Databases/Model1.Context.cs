...
namespace Tournament_422_Mazitova_Arina.Databases
{
    ...
    public partial class TournamentDB_422_Mazitova_ArinaEntities : DbContext
    {
        public TournamentDB_422_Mazitova_ArinaEntities()
            : base("name=TournamentDB_422_Mazitova_ArinaEntities")
        {
        }
